<nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded">    
    ...
    <div class="collapse navbar-collapse" id="main-navbar">
      <ul class="navbar-nav mr-auto">
        ...
        <li <?php if($current == 'customer'): ?> class="nav-item active"  <?php else: ?>  class="nav-item" <?php endif; ?>>
  ...
  </nav><?php /**PATH /home/marcelo/Documents/sis/labPHP/laravel/api-cadastro/resources/views/components/navbar.blade.php ENDPATH**/ ?>